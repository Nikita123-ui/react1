...
export const serviceType = [
  {
    icon: Icon1,
    head: "You'll Have Higher-Quality Websites/App",
    subHead:
      'This will help you deliver a smooth, bug-free experience to your website users.',
  },
  {
    icon: Icon2,
    head: 'On-Demand Service',
    subHead:
      'This option allows you to easily scale-up or scale-down service/services based on your QA projects.',
  },
  {
    icon: Icon3,
    head: 'Independent and Unbiased',
    subHead:
